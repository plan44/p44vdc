...
namespace p44 {
  ...
  class NetatmoIndoorBaseDevice;

  using NetatmoIndoorBaseDevicePtr = boost::intrusive_ptr<NetatmoIndoorBaseDevice>;

  class NetatmoIndoorBaseDevice : public NetatmoDevice
  {
    ...
    virtual ~NetatmoIndoorBaseDevice() {}
