...
#ifndef __p44vdc__netatmooutdoordevice__
...
namespace p44 {
  ...
  // MARK: ===== NetatmoOutdoorDevice


  class NetatmoOutdoorDevice;

  using NetatmoOutdoorDevicePtr = boost::intrusive_ptr<NetatmoOutdoorDevice>;

  class NetatmoOutdoorDevice : public NetatmoDevice
  {
