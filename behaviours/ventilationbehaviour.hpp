...
namespace p44 {
  ...
  public:
    AirflowDirectionChannel(OutputBehaviour &aOutput) : inherited(aOutput, "airFlowDirection") { setNumIndices(numDsVentilationDirectionStates); }; ///< see DsVentilationDirectionState enum
  ...
  public:
    ...
    virtual const char *behaviourTypeIdentifier() P44_OVERRIDE P44_FINAL { return "ventilation"; };
