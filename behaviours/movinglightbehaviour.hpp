...
namespace p44 {
  ...
  #define DEFAULT_FEATURE_MODE 0x222222  // linear, oscillating, radial
  ...
  public:
    FeatureModeChannel(OutputBehaviour &aOutput) : inherited(aOutput, "featureMode") { setMax(0x1FFFFFF); cachedChannelValue = DEFAULT_FEATURE_MODE; };
