...
#if !defined(ENABLE_SCENE_SCRIPT) && ENABLE_P44SCRIPT && P44SCRIPT_FULL_SUPPORT
...
namespace p44 {
  ...
  public:
    ...
    virtual string sceneValueString(int aChannelIndex) { return ""; /* nop in base class */}
    ...
    virtual void setSceneValueString(int aChannelIndex, const string& aValue) {/* nop in base class */}

    /// get output channel value type
    /// @param aChannelIndex the channel index (0=primary channel, 1..n other channels)
    /// @return output channel value type
    ApiValueType getChannelValueType(int aChannelIndex);
